namespace Domain.Services
{
    ...
    public class PensionServiceV1
    {
        private readonly IPersonRepository repository;
        private readonly IMailSender mailSender;

        public PensionServiceV1()
        {
            this.repository = new SomeDbRepo();
            this.mailSender = new SomeMailSender();
        }
    ...
    public class SomeDbRepo : IPersonRepository
    {
    ...
    public class SomeMailSender : IMailSender
    {
